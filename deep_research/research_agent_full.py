...
from deep_research.config import SAVE_REPORT_TO_FILE, ENABLE_SUBTOPIC_GENERATION, SUBAGENT_OUTPUT_MODE, get_supervisor_model, TARGET_LANGUAGE_FALLBACK
...
resilient_subtopic_model = get_supervisor_model(tools=subtopic_tools, max_tokens=40000)
...
async def final_report_generation(state: AgentState):
    ...
    status_tag = f"[MODE: {SUBAGENT_OUTPUT_MODE}]"
    print(f"Generated by: {status_tag}")
